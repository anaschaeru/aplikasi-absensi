    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500">
          <p class="text-xs text-green-600 font-bold uppercase">Hadir</p>
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-red-500">
          <p class="text-xs text-red-600 font-bold uppercase">Alfa / Belum Absen</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {{-- Tabel Siswa Tidak Hadir Hari Ini --}}
        <div class="bg-white rounded-lg shadow-sm p-6">
          <h4 class="font-bold text-lg mb-4 text-gray-800">Status Ketidakhadiran Hari Ini</h4>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase">Waktu
                    </th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                  @foreach ($siswaBermasalah as $absen)
                    <tr>
                      <td class="px-4 py-2 text-sm text-gray-900">{{ $absen->siswa->nama_siswa }}</td>
          ...
          @else
            <div class="text-center py-8 text-gray-500">
              <p>Luar biasa! Semua siswa hadir atau belum ada data masuk.</p>
            </div>
          @endif
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            {{-- Tombol ke Rekap Harian Detail (BARU) --}}
            <a href="{{ route('walikelas.rekap.harian') }}"
              ...
              <div>
                <p class="font-bold text-emerald-700">Rekap Harian Detail</p>
                <p class="text-sm text-emerald-600">Lihat siapa yang hadir, sakit, izin hari ini beserta fotonya.</p>
              </div>
            </a>

            {{-- Tombol ke Rekap Absensi Mapel (Fitur Guru) --}}
            <a href="{{ route('guru.dashboard', ['kelas_id' => $kelas->kelas_id]) }}"
              ...
              <div>
                <p class="font-bold text-indigo-700">Rekap Absensi Bulanan</p>
                <p class="text-sm text-indigo-500">Cek detail kehadiran mapel siswa.</p>
              </div>
            </a>
