            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        {{-- Tombol ke Rekap Absensi (Menggunakan Controller Guru tapi filter otomatis kelas ini) --}}
                        <a href="{{ route('guru.dashboard', ['kelas_id' => $kelas->kelas_id]) }}"
                            ...
                            <div>
                                <p class="font-bold text-indigo-700">Lihat Rekap Absensi Bulanan</p>
                                <p class="text-sm text-indigo-500">Cek detail kehadiran siswa kelas
                                    {{ $kelas->nama_kelas }}</p>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('guru.absensi.history') }}"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Lihat jadwal dan absensi mapel yang Anda ajar.</p>
                            </div>
                        </a>
                    </div>
                </div>
