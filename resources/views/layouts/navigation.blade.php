            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="auth()->user()->role == 'walikelas'
                            ? route('walikelas.dashboard')
                            : route('dashboard')" :active="request()->routeIs('walikelas.dashboard') || request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                ...
                @if (auth()->user()->role == 'admin')
                    ...
                    <div x-data="{ dropdownOpen: {{ request()->routeIs('admin.kelas.*') || request()->routeIs('admin.mapel.*') || request()->routeIs('admin.guru.*') || request()->routeIs('admin.siswa.*') || request()->routeIs('admin.jadwal.*') || request()->routeIs('admin.users.*') ? 'true' : 'false' }} }" class="pt-2 pb-1 border-t border-gray-200">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <svg class="w-5 h-5 transition-transform" :class="{ 'rotate-180': dropdownOpen }"
